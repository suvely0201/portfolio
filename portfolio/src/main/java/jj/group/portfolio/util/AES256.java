...
// 암복호화가 가능한 대칭키 알고리즘 _ 암호화
public class AES256 {
	
	private static final String secretKey = "sumin_portfolio_01046514580";
	private static final String IV = "vector";
	private static Key secretKeySpec;
	private static IvParameterSpec ivSpec;
	
	public static void setSecretKeySpec (Key secretKeySpec) {
		AES256.secretKeySpec = secretKeySpec;
	}
	
	public static void setIvSpec (IvParameterSpec ivSpec) {
		AES256.ivSpec = ivSpec;
	}
